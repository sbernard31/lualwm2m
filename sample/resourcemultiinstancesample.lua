...
local deviceObj = obj.new(3, {
  ...
  [6]  = {read = function()                        -- Available Power Sources
    return {[0]=0,[1]=7}                           -- ->(0)DC power, (7)Solar
  end
  },
...
local ll = lwm2m.init("lua-client-resourcemultiinstance", {securityObj, serverObj, deviceObj},
